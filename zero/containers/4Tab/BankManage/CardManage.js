...
import {zdp, zsp} from "../../../utils/ScreenUtil";
 ...
 class CardManage extends BaseComponent {
    ...
    render() {
        return (
            <View style={{flex: 1, justifyContent: 'flex-start', alignItems: 'center'}}>
                <MyTabView titleColor={'black'} title={'银行卡管理'}
                           leftView={true}
                ...
                <TouchableOpacity activeOpacity={0.8} style={{
                    ...
                    this.props.navigation.navigate('SwipeDeleteCard',{cardType:1})
                }}>
                    <Text style={{fontSize: zsp(16), color: 'black'}}>结算卡</Text>
                ...
                <TouchableOpacity activeOpacity={0.8} style={{
                    ...
                    this.props.navigation.navigate('SwipeDeleteCard',{cardType:0})
                }}>
                    <Text style={{fontSize: zsp(16), color: 'black'}}>支付卡</Text>
                    <Icon size={zdp(30)} name={'angle-right'}
                          style={{color: 'black', backgroundColor: 'transparent'}}/>
                </TouchableOpacity>
            </View>)
