...
import {zHeight, zsp, zWidth} from "../ScreenUtil";
...
export default class GesturePassword extends Component {
    ...
    render() {
        ...
        return (
            <LinearGradient
                ...
                locations={[0, 1]}
                colors={['#3B6FB9', '#4B4E96']}>

                <ZText
                    parentStyle={{width: zWidth, height: Top / 1.5, backgroundColor: 'transparent',
                        justifyContent:'flex-end', alignItems: 'center'
                    }}
                    content={this.state.message || this.props.message}
                    fontSize={zsp(18)}
                    color={color}/>
    ...
    renderCircles() {
        ...
        this.state.circles.forEach(function (c, i) {
            ...
            array.push(
                <Circle key={'c_' + i} fill={fill} normalColor={normalColor} color={color} x={c.x}
                        y={c.y} r={Radius} inner={inner} outer={outer}/>
            )
        });
